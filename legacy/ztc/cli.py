...
# Core commands are now imported from libs.cli.core_commands
# Commands are registered via add_typer() in the main block
...
if __name__ == "__main__":
    ...
    # Register core commands from libs.cli.core_commands
    from libs.cli.core_commands import app as core_app
    app.add_typer(
        core_app,
        name="",  # Empty name mounts commands at root level
